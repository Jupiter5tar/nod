...
class Particle {
  constructor(effect) {
    ...
    this.angle = 0;
    this.newAngle = 0;
    this.angleCorrector = Math.random() * 5 + 0.1;
    this.timer = this.maxLength * 2;
    this.colors = ["#233142", "#455d7a", "#f95959", "#e3e3e3"];
...
class Effect {
  ...
  drawText() {
    ...
    gradient1.addColorStop(0.4, "rgb(59, 125, 128)");
    gradient1.addColorStop(0.6, "rgb(105, 52, 75)");
    gradient1.addColorStop(0.8, "rgb(207, 35, 109)");
